...
#     "Write the list of the top 5 best headphones and their prices to a file and output, display  the file path",
...
# ]
agent.goals = [
    "Write the word dog yo a file and output, display  the file path",
    "There will be no user assistance. Terminate once writing both files is complete.",
]
agent.cli()
