...
layout = html.Div(
    [
        dcc.Input(id="ainput-symbol", type="text", placeholder="", debounce=True),
        html.Div(id='aoutput-symbol'),
        html.Div(id="alisting-table")
    ]
    )


@callback(
    Output('aoutput-symbol','children'),
    Output('alisting-table', 'children'),
    Input('ainput-symbol', 'value')
)
