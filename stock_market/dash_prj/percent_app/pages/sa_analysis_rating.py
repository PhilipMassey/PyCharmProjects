...
results_date = html.Div('Current date',id='results-date-a',
...
results_table = html.Div(id="results-table-a")
...
@callback(
    Output('results-date-a','children'),
    Output('results-table-a', 'children'),
    Input('dropdown-dirs-a', 'value'),
...
@callback(Output("event-a", "children"), Input("el", "event"), Input("el", "n_events"))
